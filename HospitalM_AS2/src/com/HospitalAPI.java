...
public class HospitalAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = hospitalObj.insertHospital(request.getParameter("hospitalName"),
		request.getParameter("hospitalRegistereDate"),
		request.getParameter("hospitalType"), 
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = hospitalObj.updateHospital(paras.get("hidHospIDSave").toString(),     
		paras.get("hospitalName").toString(),
		paras.get("hospitalRegistereDate").toString(),
		paras.get("hospitalType").toString(),
